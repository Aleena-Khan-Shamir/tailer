...
class PostCardForVisitor extends StatefulWidget {
  final snap;
  const PostCardForVisitor({
    Key? key,
    required this.snap,
  }) : super(key: key);

  @override
  State<PostCardForVisitor> createState() => _PostCardForVisitorState();
}

class _PostCardForVisitorState extends State<PostCardForVisitor> {
  @override
