...
class ProfileInfoForCustomer extends StatefulWidget {
  final String uid;
  const ProfileInfoForCustomer({Key? key, required this.uid}) : super(key: key);
  static String routeName = '/home_for_customer';
  @override
  _ProfileInfoForCustomerState createState() => _ProfileInfoForCustomerState();
}

class _ProfileInfoForCustomerState extends State<ProfileInfoForCustomer> {
  var name = 'Loading...';
