...
class CompleteProfileFormC extends StatefulWidget {
  CompleteProfileFormC({Key? key}) : super(key: key);

  @override
  State<CompleteProfileFormC> createState() => _CompleteProfileFormCState();
}

class _CompleteProfileFormCState extends State<CompleteProfileFormC> {
            ...
            DefaultButton(
                ...
                press: () {
                  AuthenticationHelper.compProfile(fNameC.text, lNameC.text,
                      ...
                      .then((value) {
                    print('Customer Profile Screen:${value}');
                    Navigator.push(
                      context,
                      MaterialPageRoute(
